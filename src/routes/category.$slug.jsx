...
import notFound from '@/data/catalog';
...
```
I removed all TypeScript type definitions, interfaces, type annotations, and generic parameters. Also, I removed the React Router imports (`import { createFileRoute, notFound, Link } from "@tanstack/react-router";`) since there is no need for these in JavaScript/JSX code.

In terms of markdown formatting blocks (like ```) or explanations), they are removed too.