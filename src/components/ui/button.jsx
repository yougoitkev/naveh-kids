convert the following TypeScript/TSX code into clean, working JavaScript/JSX code. remove all TypeScript type definitions, interfaces, type annotations, and generic parameters. keep all React logic, hooks, and imports intact.
    ...
    variants: {
      variant: {
        "outline": [
          ...
          {
            default:
              [[{ background: ["border", "input"], color: ["text"] }], {}],
          },
        ],
        link: [{ baseClassName: [] }],
        ghost: [
